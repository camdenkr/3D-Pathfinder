...
view(0,90);  %rotate to view this line
xyz1 = evalin('base','currPt')
...
x(1) = (xyz1(1,1) - limx(1))/(limx(2) - limx(1))*128;
x(2) = (xyz2(1,1) - limx(1))/(limx(2) - limx(1))*128;
y(1) = (xyz1(1,2) - limy(1))/(limy(2) - limy(1))*128;
y(2) = (xyz2(1,2) - limy(1))/(limy(2) - limy(1))*128;
